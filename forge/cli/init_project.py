...
"""
    ...
    console.print("  [cyan]runtime/[/cyan]           Generated code (disposable)")
    console.print("  [cyan]CLAUDE.md[/cyan]          LLM operating manual")
    console.print("  [cyan].env[/cyan]               Environment configuration")
    console.print()
    console.print("[bold]Next steps:[/bold]")
    console.print(f"  1. cd {name}")
    console.print("  2. Edit .env (add your LLM API key)")
    console.print("  3. Open your LLM and start building")
