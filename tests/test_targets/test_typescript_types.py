            ...
            EntityIR(
                ...
                fields=[
                    FieldIR(
                        name="agent_id",
                        type="uuid",
                        reference=ReferenceIR(target_entity="entity/support/agent"),
                    )
                ],
            ),
        ],
