    ...
    def test_over_long_identifier_is_rejected(self) -> None:
        ...
        ir = DomainIR(
            ...
            entities=[
                _entity(
                    fields=[
                        FieldIR(name=long_name, type="string"),
                        *_identity_fields(),
                    ]
                )
            ],
    ...
    def test_apostrophe_in_default_is_escaped(self) -> None:
        ir = DomainIR(
            ...
            entities=[
                _entity(
                    fields=[
                        FieldIR(name="note", type="string", default="O'Brien"),
                        *_identity_fields(),
                    ]
                )
            ],
...
class TestIndexes:
    ...
    def test_declared_filter_gets_a_composite_index(self) -> None:
        ...
        assert (
            'CREATE INDEX "idx_orders_state" ON "orders" ("state", "created_at" DESC, "id" DESC);'
        ) in _schema(ir)
        ...
        ir = DomainIR(
            ...
            entities=[
                _entity(
                    fields=[
                        FieldIR(
                            name="amount", type="decimal", constraints={"precision": 12, "scale": 4}
                        ),
